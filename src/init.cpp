...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/amorecoin-project/amorecoin>";
    const std::string URL_WEBSITE = "<https://amorecoin.org>";
