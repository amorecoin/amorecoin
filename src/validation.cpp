...
#if defined(NDEBUG)
# error "Amorecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Amorecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s AMOR additional fees, %d delta bytes\n",
...
{
    // Height must be adjusted here due to premine, so maximum coin will stay at 210000000.
    int adjustedHeight = nHeight + 1260000;
    ...
    // For premine, get 30% from avaliable coin.
    if (nHeight == 1) {
        nSubsidy = 63000000 * COIN;
    }
