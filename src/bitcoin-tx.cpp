...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s amorecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  amorecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded amorecoin transaction") + "\n" +
              "  amorecoin-tx [options] -create [commands]   " + _("Create hex-encoded amorecoin transaction") + "\n" +
              "\n";
