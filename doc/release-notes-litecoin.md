Amorecoin Core version *0.15.1* is now available from:

  <https://download.amorecoin.org/amorecoin-0.15.1/>
...
A number of changes to the way Amorecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 affection per kB (0.00001 AMOR). This is to prepare for dropping the minimum transaction fee to 0.1 affection per kB (0.0001 AMOR) in the next release.
